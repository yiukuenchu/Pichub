  ...
  <body>
    <div class="f-pusher">
      ...
      <div class="container" id="vue">
        ...
        <b-modal ref="editModal" title="添加作品" ok-title="Save" @ok.prevent="submitForm" tabindex="-1" role="dialog" aria-hidden="true">
          <form id="editform">
           <input type="hidden" name="productID" value="" v-model="formData.productID">
           <div class="form-group">
             <label class="col-form-label">作品名称</label>
           ...
           <div class="form-group">
             <label class="col-form-label">作品 URL</label>
           ...
           <div class="form-group">
             <label class="col-form-label">颜色</label>
           ...
           <div id="btn-delete" v-show="formData.action === 'update'" class="btn btn-danger"><span class="fas fa-trash"></span> 删除作品</div>
