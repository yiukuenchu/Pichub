...
<html>
  ...
  <body>
      ...
      <div class="container" id="order-form">
        ...
        <form action="" method="post">
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="text" name="city" placeholder="Chengdu" value="<?php if(!empty($_POST['city'])) echo $_POST['city']; ?>">
          </div>
          <div class="form-group">
            <label>State</label>
            ...
            <small class="text-muted">请输入两个字母的缩写 (PA)</small>
          </div>
          <div class="form-group">
            <label>邮编</label>
    ...
    <?php else: ?>
      ...
      <div class="jumbotron">
        <div class="container">
          <h1 class="display-4 text-success">订单成功！</h1>
          <p class="lead">感谢购买！Enjoy！</p>
        </div>
      </div>
